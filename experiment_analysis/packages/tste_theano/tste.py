...
def tste(triplets, no_dims=2, lamb=0, alpha=None, use_log=True, verbose=True, max_iter=1000, save_each_iteration=False, initial_X=None, static_points=np.array([]), normalize_gradient=True, ignore_zeroindexed_error=True):
